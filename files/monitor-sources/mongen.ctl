...
@ENABLE
@DEFINE MON: DSK:,ps:<monitor-sources>
@DEFINE R: DSK:
@COMPILE /COMPILE mon:SITE.MAC+mon:REL1.MAC+mon:MONSYM.MAC
@COMPILE /COMPILE /NOBIN mon:SITE.MAC+mon:MONSYM.MAC
@EXECUTE /COMPILE mon:SITE.MAC+mon:ERBLD.MAC+mon:REL1.MAC+mon:MONSYM.MAC ERBLD.REL
@DELETE ERBLD.REL
@COMPILE mon:site.mac+MON:SYSFLG.MAC+MON:PROLOG.MAC R:PROLOG
@compile /nobin mon:chadfs
...
@COMPILE MON:NAMMON.MAC+MON:VEDIT.MAC+MON:VERSIO.MAC R:VERSIO
					;Storage
@COMPILE mon:site.mac+MON:PARMON.MAC+MON:PARNEW.MAC+MON:PARAMS.MAC+MON:STG.MAC R:STG
